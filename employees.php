...
$current_page = 'employees';        // matches the page key in sidebar
$page_title   = 'Employees';        // for <title>
$breadcrumbs  = [
    ['label' => 'HR & Finance'],    // no URL -> just text
    ['label' => 'Employees']        // last item = current page
];
?>
<!DOCTYPE html>
...
<style>
/* ── All CSS from your original employees.php (unchanged) ── */
[data-theme="dark"] {
