...
<div class="sidebar" id="sidebar">
  <div class="slogo">
    <div class="logo-icon"><svg viewBox="0 0 18 18" fill="none" stroke="#fff" stroke-width="2"><path d="M3 9l3 3 4-5 4 4"/><rect x="1" y="1" width="16" height="16" rx="3"/></svg></div>
    <span class="logo-txt">Sales<span>OS</span></span>
  </div>
  <div class="nav-sec">
    <span class="nav-lbl">Main</span>
    <a class="nav-item" href="index.php"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="1" y="1" width="6" height="6" rx="1.5"/><rect x="9" y="1" width="6" height="6" rx="1.5"/><rect x="1" y="9" width="6" height="6" rx="1.5"/><rect x="9" y="9" width="6" height="6" rx="1.5"/></svg>Dashboard</a>
  </div>
  <div class="nav-sec">
    <span class="nav-lbl">Sales</span>
    <a class="nav-item" href="#"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M2 12V6l6-4 6 4v6"/><path d="M6 12V9h4v3"/></svg>Sales Orders<?php if($pending_sales_badge>0):?><span class="nbadge"><?=$pending_sales_badge?></span><?php endif;?></a>
    ...
    <a class="nav-item" href="#"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M8 1v14M1 8h14"/></svg>Debts<?php if($debt_badge>0):?><span class="nbadge"><?=$debt_badge?></span><?php endif;?></a>
  </div>
  <div class="nav-sec">
    ...
    <a class="nav-item" href="#"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="2" y="6" width="12" height="8" rx="1"/><path d="M5 6V4a3 3 0 016 0v2"/></svg>Stock<?php if($low_stock_count>0):?><span class="nbadge b"><?=$low_stock_count?></span><?php endif;?></a>
  ...
  <div class="nav-sec">
    ...
    <a class="nav-item" href="employees.php"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="5" cy="5" r="3"/><circle cx="11" cy="5" r="3"/><path d="M1 14c0-2.76 1.8-5 4-5M15 14c0-2.76-1.8-5-4-5M7 14c0-2.76.9-5 2-5s2 2.24 2 5"/></svg>Employees</a>
    <a class="nav-item active" href="salaries.php"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="8" cy="8" r="6"/><path d="M8 5v3l2 2"/></svg>Salaries</a>
  ...
  <div class="nav-sec">
    ...
    <a class="nav-item" href="#"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M8 1a5 5 0 015 5v2l1.5 2.5h-13L3 8V6a5 5 0 015-5z"/><path d="M6 13a2 2 0 004 0"/></svg>Notifications<?php if($unread_notifs>0):?><span class="nbadge"><?=$unread_notifs?></span><?php endif;?></a>
  ...
  <div class="sfooter">
    <div class="ucard">
      ...
      <div class="uinfo"><div class="uname"><?=$user?></div><div class="urole"><?=$role?></div></div>
    </div>
  </div>
</div>
