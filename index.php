...
$current_page = 'dashboard';          // matches the page key in sidebar
$page_title   = 'Dashboard';          // used for <title>
$breadcrumbs  = [['label' => 'Dashboard']]; // simple breadcrumb
...
// Set variables for sidebar & topnav
...
<style>
/* All the CSS from the original index.php remains unchanged */
[data-theme="dark"] {
  --bg:    #0D0F14;
  --bg2:   #13161D;
  --bg3:   #191D27;
...
/* Sidebar styles (moved to sidebar.php, but kept for reference) */
/* ... */

/* Main styles */
.main { margin-left: 248px; flex: 1; display: flex; flex-direction: column; min-height: 100vh; }

/* Topnav styles (moved to topnav.php) */
/* ... */
...
// Sidebar nav (handled by sidebar.php, but we keep for local clicks?)
